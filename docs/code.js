...
new Vue({ 
    ...
    methods: {
        ...
        makeTemplate() {
            ...
            if(this.form.ticket.description_resm) {
                strTemplate += this.form.ticket.description_resm + "\n\n";
            }
            ...
            if(this.form.employee.id) {
                strTemplate += "•CPF/CNPJ: " + this.form.employee.id + "\n";
            }
            if(this.form.employee.phone) {
                strTemplate += "•Telefone: " + this.form.employee.phone + "\n";
            }
            if(this.form.employee.filial) {
                strTemplate += "•Filial: " + this.form.employee.filial + "\n";
            }
            if(this.form.employee.razao) {
                strTemplate += "•Razão Social: " + this.form.employee.razao + "\n";
            }
            if(this.form.employee.mail) {
                strTemplate += "•E-mail: " + this.form.employee.mail + "\n";
            }
